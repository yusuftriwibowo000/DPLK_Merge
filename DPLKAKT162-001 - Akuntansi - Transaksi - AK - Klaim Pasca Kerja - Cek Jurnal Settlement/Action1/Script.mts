...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT162-001 - Akuntansi - Transaksi - AK - Klaim Pasca Kerja - Cek Jurnal Settlement.xlsx", "DPLKAKT162-001")
Call spGetDatatable()
...
Call Get_Cell_Data_By_Row_And_Col(3,10)
...
Call Search_Nilai_Transaksi_Pasca_Kerja_dari_Entry_Jurnal_Transaksi(Cell_Data_By_Row_And_Col)
Call AC_Logout()
