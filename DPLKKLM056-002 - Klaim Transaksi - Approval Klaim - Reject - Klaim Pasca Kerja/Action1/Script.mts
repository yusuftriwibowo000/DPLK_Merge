...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM056-002 - Klaim Transaksi - Approval Klaim - Reject - Klaim Pasca Kerja.xlsx", "DPLKKLM056-002")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Ke_Approve_Calculate_Klaim_Pasca_Kerja()
Call AC_Logout()
