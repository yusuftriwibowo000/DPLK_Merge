...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM075-001 - Klaim Transaksi - Koreksi Rekening Klaim - Approve.xlsx", "DPLKKLM075-001")
Call spGetDatatable()
...
Call Approve_Koreksi_Rekening_Klaim
Call AC_Logout()
