...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM041-002 - Klaim Transaksi - Draft Register Klaim - Status Anuitas - Klaim Pensiun.xlsx", "DPLKKLM041-002")
Call spGetDatatable()
...
Call Tambah_Transaksi_Register_Tgl_SK_Pensiun()
Call Tambah_Transaksi_Register_Isi_Informasi_Rekening_Penerima_Dana()
Call Tambah_Transaksi_Register_Isi_Dokumen_Klaim()
Call Tambah_Transaksi_Register_Isi_Informasi_Dana_Annuitas()
Call Validasi_Isi_Field_Register_Klaim()
Call Check_Notification_Simpan_Draft()
Call DA_Logout("0")
