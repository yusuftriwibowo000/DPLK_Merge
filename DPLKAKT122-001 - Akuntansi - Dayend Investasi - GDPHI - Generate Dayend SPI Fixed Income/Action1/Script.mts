...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT122-001 - Akuntansi - Dayend Investasi - GDPHI - Generate Dayend SPI Fixed Income.xlsx", "DPLKAKT122-001")
Call spGetDatatable()
...
REM ------- DPLK
	...
	Call DA_Login()
	Call AC_GoTo_Menu()
	Call Generate_Dayend_SPI_Investasi()
