...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS146-001 until DPLKKPS146-002 - Kepesertaan - Transaksi - Register Split Balance (Bulk).xlsx", "DPLKKPS146-001")
Call spGetDatatable()
