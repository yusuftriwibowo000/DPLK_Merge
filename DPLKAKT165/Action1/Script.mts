...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT165-001 - Akuntansi - Transaksi - SJS - Cek Jurnal Settlement Transaksi Klaim Kolektif.xlsx", "DPLKAKT165-001")
Call spGetDatatable()
...
Call DA_Login()
Call Ambil_Banyaknya_Data_Tabel_Approval_Klaim_Kolektif()
Call AC_GoTo_Menu()
Call Lihat_Transaksi_Klaim_Approval_Klaim_Kolektif()
For Iterator = 1+1 To Ambil_Banyaknya_Data_Tabel_Approval_Klaim_Kolektif Step 1
	Call AC_GoTo_Menu_No_SS()
	Call Lihat_Transaksi_Klaim_Approval_Klaim_Kolektif_No_SS
	Call Get_CLM_Number_From_Approval_Klaim_Kolektif(Iterator,1)
	Call AC_Direct_GoTo_Menu("Entry Jurnal Transaksi",1)
	Call Fill_Search_Entry_Jurnal_Transaksi_Using_Parameter(CLM,"","")
	Call Ambil_Jumlah_Baris_Search_Entry_Jurnal_Transaksi_v2
	For Iterator2 = 1+2 To Ambil_Jumlah_Baris_Search_Entry_Jurnal_Transaksi_v2 Step 1
		If Iterator2 <> 3 Then
			Call AC_Direct_GoTo_Menu("Entry Jurnal Transaksi",1)
			Call Fill_Search_Entry_Jurnal_Transaksi_Using_Parameter(CLM,"","")
		End If
		Call Ambil_Kode_Jurnal_Standar_using_Row(Iterator2)
		Call AC_Direct_GoTo_Menu("Setup Jurnal Standar",1)
