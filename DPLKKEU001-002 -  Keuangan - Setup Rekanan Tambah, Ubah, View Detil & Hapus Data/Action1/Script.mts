...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKEU001-002 - Setup Rekanan Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKEU001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupRekanan()
ElseIf iteration = 2 Then
	Call ViewSetupRekanan()
ElseIf iteration = 3 Then
	Call EditSetupRekanan()
ElseIf iteration = 4 Then
	Call DeleteSetupRekanan()
End If
