...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM073-001 - Klaim Transaksi - Cfm Send to Cal Desk - Klaim Pensiun.xlsx", "DPLKKLM073-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Konfirmasi_Klaim_Pensiun_Ke_Validasi()
Call AC_Logout()
