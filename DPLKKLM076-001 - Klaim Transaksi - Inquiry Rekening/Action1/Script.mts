...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM076-001 - Klaim Transaksi - Inquiry Rekening.xlsx", "DPLKKLM076-001")
Call spGetDatatable()
...
Call Search_Inquiry_Rekening()
Call Lihat_Inquiry_Rekening()
Call Compare_Inquiry_Rekening()
Call AC_Logout()
