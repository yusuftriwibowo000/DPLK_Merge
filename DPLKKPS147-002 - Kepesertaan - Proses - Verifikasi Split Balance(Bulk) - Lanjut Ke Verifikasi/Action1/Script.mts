...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS147-001 until DPLKKPS147-002 - Kepesertaan - Proses - Verifikasi Split Balance (Bulk).xlsx", "DPLKKPS147-002")
Call spGetDatatable()
...
Call VerifikasiSplitBalanceBulk()
