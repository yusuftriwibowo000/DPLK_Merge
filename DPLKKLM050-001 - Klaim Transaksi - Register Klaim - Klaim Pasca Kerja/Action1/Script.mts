...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM050-001 - Klaim Transaksi - Register Klaim - Klaim Pasca Kerja.xlsx", "DPLKKLM050-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Otorisasi_Register_Klaim_Pasca_Kerja()
Call AC_Logout()
