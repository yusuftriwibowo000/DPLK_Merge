...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT149-001 - Akuntansi - Transaksi - IDTD - Keu Dep Break - Cek Jurnal Keuangan - Penerimaan Transaksi Break Deposito.xlsx", "DPLKAKT149-001")
Call spGetDatatable()
...
Call Ambil_Nilai_Tiket_ID("DTDEP",14)
Call AC_GoTo_Menu()
