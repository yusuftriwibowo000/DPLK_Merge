...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM047-001 - Klaim Transaksi - Calculate Klaim  - Send to Approval - Klaim Pensiun.xlsx", "DPLKKLM047-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_dan_Ubah_Transaksi_Calculate()
Call Validasi_Isi_Field_Calculate_Klaim()
Call Kirim_Ke_APR_Desk()
Call DA_Logout("0")
