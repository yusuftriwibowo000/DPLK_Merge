...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM057-001 - Klaim Transaksi - Draft Register - Klaim Kolektif.xlsx", "DPLKKLM057-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Tambah_Register_Klaim_Kolektif()
Call AC_Logout()
