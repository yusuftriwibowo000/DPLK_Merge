...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM062-001 - Klaim Transaksi - Return to Reg - Klaim Kolektif.xlsx", "DPLKKLM062-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Register_Klaim_Kolektif()
Call AC_Logout()
