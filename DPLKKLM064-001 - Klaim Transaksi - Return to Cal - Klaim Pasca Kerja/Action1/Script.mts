...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM064-001 - Klaim Transaksi - Return to Cal - Klaim Pasca Kerja.xlsx", "DPLKKLM064-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Calculate_Klaim_Pasca_Kerja
Call AC_Logout()
