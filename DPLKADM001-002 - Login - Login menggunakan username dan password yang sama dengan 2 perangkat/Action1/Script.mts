...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM001-002 - Login - Login menggunakan username dan password yang sama dengan 2 perangkat.xlsx", "DPLKADM001")
Call spGetDatatable()
...
Call DA_Login()
wait 5
msgbox "Silahkan Masukan Akun dengan username : " & DataTable.Value("USERID",dtlocalsheet) & " Serta Password : " & DataTable.Value("PASSWORD",dtlocalsheet) & " Di Perangkat Lain, Bila Sudah Tekan OK"
Set objkey = CreateObject("WScript.Shell")

Do 
objkey.sendkeys "{F5}"
wait 2
Loop until Browser("DPLK").Page("Login").WebButton("Btn Login").Exist(2)

wait 5
Call CaptureImageUFTV2(Browser("DPLK").Page("Login"), "Terdapat Error", " " , compatibilityMode.Desktop, ReportStatus.Passed)
wait 2
Call spReportSave()
