...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM065-001 - Klaim Transaksi - Return to Val - Klaim Pasca Kerja.xlsx", "DPLKKLM065-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Validasi_Klaim_Pasca_Kerja()
Call AC_Logout()
