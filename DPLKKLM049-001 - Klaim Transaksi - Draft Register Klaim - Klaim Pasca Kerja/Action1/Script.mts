...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM049-001 - Klaim Transaksi - Draft Register Klaim - Klaim Pasca Kerja.xlsx", "DPLKKLM049-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Tambah_Transaksi_Register_Klaim_Pasca_Kerja()
Call Fill_Informasi_Rekening_Penerima_Dana_Register_Klaim_Pasca_Kerja()
Call Tambah_Register_Klaim_Pasca_Kerja_Isi_Dokumen_Klaim()
Call Validasi_Isi_Field_Register_Klaim_Pasca_Kerja()
