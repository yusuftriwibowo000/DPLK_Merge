...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM051-001 - Klaim Transaksi - Otorisasi Klaim - Klaim Pasca Kerja.xlsx", "DPLKKLM051-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Validasi_Otorisasi_Klaim_Pasca_Kerja()
Call AC_Logout()
