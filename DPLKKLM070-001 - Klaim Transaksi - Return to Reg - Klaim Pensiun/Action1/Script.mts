...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM070-001 - Klaim Transaksi - Return to Reg - Klaim Pensiun.xlsx", "DPLKKLM070-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Regristrasi_Klaim_Pensiun
Call AC_Logout()
