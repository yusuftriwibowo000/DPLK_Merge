...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM042-001 - Klaim Transaksi - Register Klaim - Klaim Pensiun.xlsx", "DPLKKLM042-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_dan_Ubah_Transaksi_Register()
Call Validasi_Isi_Field_Otorisasi_Klaim()
Call Kirim_Ke_Otorisasi()
Call DA_Logout("0")
