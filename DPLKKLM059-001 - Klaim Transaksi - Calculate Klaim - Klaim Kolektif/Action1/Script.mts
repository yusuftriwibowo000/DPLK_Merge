...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM059-001 - Klaim Transaksi - Calculate Klaim - Klaim Kolektif.xlsx", "DPLKKLM059-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Hitung_Calculate_Register_Klaim_Kolektif
Call AC_Logout()
