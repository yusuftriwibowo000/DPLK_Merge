...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM045-002 - Klaim Transaksi - Calculate Klaim - Hitung - Status Khusus - Klaim Pensiun.xlsx", "DPLKKLM045-002")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_Transaksi_Calculate()
Call Hitung_Calculate_Klaim_With_Status()
Call DA_Logout("0")
Call spReportSave()
