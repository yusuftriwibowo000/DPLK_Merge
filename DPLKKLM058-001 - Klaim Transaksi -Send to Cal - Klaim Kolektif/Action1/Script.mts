...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM058-001 - Klaim Transaksi -Send to Cal - Klaim Kolektif.xlsx", "DPLKKLM058-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Calculate_Register_Klaim_Kolektif()
Call AC_Logout()
