...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT126-001 - Akuntansi - Transaksi - NAB - Inquiry Data NAB.xlsx", "DPLKAKT126-001")
Call spGetDatatable()
...
REM ------- DPLK
	...
	Call DA_Login()
	Call AC_GoTo_Menu()
	Call Search_And_View_Inquiry_Data_NAB_All()
	Call DA_Logout("0")
