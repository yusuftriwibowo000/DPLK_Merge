...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM071-001 - Klaim Transaksi - Batalkan Klaim - Klaim Pensiun.xlsx", "DPLKKLM071-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Batalkan_Regristrasi_Klaim_Pensiun
Call AC_Logout()
