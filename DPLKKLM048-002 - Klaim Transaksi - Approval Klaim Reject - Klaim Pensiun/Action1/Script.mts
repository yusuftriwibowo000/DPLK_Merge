...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM048-002 - Klaim Transaksi - Approval Klaim Reject - Klaim Pensiun.xlsx", "DPLKKLM048-002")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_dan_Ubah_Transaksi_Approval()
Call Validasi_Isi_Field_Approve_Klaim()
Call Kirim_Ke_Approve()
Call DA_Logout("0")
