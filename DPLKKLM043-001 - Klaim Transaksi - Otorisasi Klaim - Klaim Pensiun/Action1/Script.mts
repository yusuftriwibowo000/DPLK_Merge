...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM043-001 - Klaim Transaksi - Otorisasi Klaim - Klaim Pensiun.xlsx", "DPLKKLM043-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_dan_Ubah_Transaksi_Otorisasi()
Call Kirim_Ke_Val_Desk()
Call DA_Logout("0")
