...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKEU001-003 - Setup Pegawai Tambah, Ubah, View Detil & Hapus Data.xlsx", "DPLKKEU001")
Call spGetDatatable()
...
If iteration = 1 Then
	Call AddSetupPegawai()
ElseIf iteration = 2 Then
	Call ViewSetupPegawai()
ElseIf iteration = 3 Then
	Call EditSetupPegawai()
ElseIf iteration = 4 Then
	Call DeleteSetupPegawai()
End If
