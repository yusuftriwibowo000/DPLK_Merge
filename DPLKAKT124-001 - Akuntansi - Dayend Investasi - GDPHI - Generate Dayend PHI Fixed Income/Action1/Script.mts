...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT124-001 - Akuntansi - Dayend Investasi - GDPHI - Generate Dayend PHI Fixed Income.xlsx", "DPLKAKT124-001")
Call spGetDatatable()
...
REM ------- DPLK
	...
	Call DA_Login()
	Call AC_GoTo_Menu()
	Call Generate_Dayend_PHI_Investasi()
	Call Search_And_View_Generate_Dayend_SPI_PHI_Investasi()
	Call DA_Logout("0")
