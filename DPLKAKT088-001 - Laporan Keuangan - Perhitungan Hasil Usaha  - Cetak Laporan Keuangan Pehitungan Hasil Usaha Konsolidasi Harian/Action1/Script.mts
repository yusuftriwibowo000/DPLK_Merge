...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT088-001 - Laporan Keuangan - Perhitungan Hasil Usaha  - Cetak Laporan Keuangan Pehitungan Hasil Usaha Konsolidasi Harian.xlsx", "DPLKAKT088-001")
Call spGetDatatable()
...
Call OpenLastDownloadFile_Scroll_Screen(28)
Call spReportSave()
