...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKADM009-001 - Setup Role Menu - View Detil Data.xlsx", "DPLKADM009-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Lihat_Setup_Administration_Setup_Role_Menu()
Call DA_Logout("0")
Call spReportSave()
