...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT091-001 - Laporan Keuangan - Perubahan Aset Neto - Cetak Laporan Keuangan Perubahan Aset Neto Konsolidasi Harian.xlsx", "DPLKAKT091-001")
Call spGetDatatable()
...
Call OpenLastDownloadFile_Scroll_Screen(53)
Call spReportSave()
