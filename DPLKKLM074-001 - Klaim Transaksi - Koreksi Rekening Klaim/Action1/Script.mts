...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM074-001 - Klaim Transaksi - Koreksi Rekening Klaim - Save.xlsx", "DPLKKLM074-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cari_Koreksi_Rekening_Klaim
Call Lihat_Koreksi_Rekening_Klaim
Call Ubah_Koreksi_Rekening_Klaim
Call Simpan_Koreksi_Rekening_Klaim
Call AC_Logout()
