...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM054-001 - Klaim Transaksi - Calculate Klaim - Cetak Hitungan - Klaim Pasca Kerja.xlsx", "DPLKKLM054-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Cetak_Hitungan_Calculate_Klaim_Pasca_Kerja()
