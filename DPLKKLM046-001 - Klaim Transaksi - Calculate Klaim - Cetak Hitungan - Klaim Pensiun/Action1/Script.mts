...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM046-001 - Klaim Transaksi - Calculate Klaim - Cetak Hitungan - Klaim Pensiun.xlsx", "DPLKKLM046-001")
Call spGetDatatable()
...
Call Cetak_Hitungan_Calculate_Klaim()
Call DA_Logout("0")
