...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM069-001 - Klaim Transaksi - Return to Val - Klaim Pensiun.xlsx", "DPLKKLM069-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Vadilasi_Klaim_Pensiun
Call AC_Logout()
