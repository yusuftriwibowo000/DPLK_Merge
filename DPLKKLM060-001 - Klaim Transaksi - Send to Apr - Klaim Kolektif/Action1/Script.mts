...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM060-001 - Klaim Transaksi - Send to Apr - Klaim Kolektif.xlsx", "DPLKKLM060-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Approval_Calculate_Register_Klaim_Kolektif
Call AC_Logout()
