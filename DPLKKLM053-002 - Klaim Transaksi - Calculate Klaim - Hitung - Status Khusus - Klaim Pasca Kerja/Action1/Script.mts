...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM053-002 - Klaim Transaksi - Calculate Klaim - Hitung - Status Khusus - Klaim Pasca Kerja.xlsx", "DPLKKLM053-002")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Kalkulasi_Validasi_Klaim_Pasca_Kerja_With_Status()
Call AC_Logout()
