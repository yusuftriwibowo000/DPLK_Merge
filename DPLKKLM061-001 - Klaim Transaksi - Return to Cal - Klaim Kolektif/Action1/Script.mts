...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM061-001 - Klaim Transaksi - Return to Cal - Klaim Kolektif.xlsx", "DPLKKLM061-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Calculate_Klaim_Kolektif()
Call AC_Logout()
