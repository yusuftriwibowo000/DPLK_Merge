...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM053-001 - Klaim Transaksi - Calculate Klaim - Hitung - Klaim Pasca Kerja.xlsx", "DPLKKLM053-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Kalkulasi_Validasi_Klaim_Pasca_Kerja()
Call AC_Logout()
