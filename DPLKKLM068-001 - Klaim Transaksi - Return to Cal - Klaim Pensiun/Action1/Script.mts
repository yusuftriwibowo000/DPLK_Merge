...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM068-001 - Klaim Transaksi - Return to Cal - Klaim Pensiun.xlsx", "DPLKKLM068-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Calculate_Klaim_Pensiun
Call AC_Logout()
