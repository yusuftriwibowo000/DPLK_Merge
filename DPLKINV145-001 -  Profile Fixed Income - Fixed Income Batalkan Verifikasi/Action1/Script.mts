...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKINV145-001 -  Profile Fixed Income - Fixed Income Batalkan Verifikasi.xlsx", "DPLKINV145-001")
Call spGetDatatable()
...
Call UnverifiedProfileFixedIncome()
