...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT014-004 - Akuntansi - DEP.ARO - Cek Jurnal Perpanjang Deposito Bank DKI Cabang Utama Juanda DTDEP202200103 PRI01-Deposito Pasar Uang 3,1.xlsx", "DPLKAKT014")
Call spGetDatatable()
...
If Iteration mod 3 = 1 Then
	Call AC_GoTo_Menu()
	Call Lihat_Entry_Jurnal_Transaksi_With_Keyword(5,DataTable.Value("KEYWORD_SEARCH",dtlocalsheet),1,"WebElement")
	Call Compare_Debit_And_Credit()
ElseIf Iteration mod 3 = 2 Then	
	Call Ambil_Kode_Jurnal_Standar_With_Keyword(5,DataTable.Value("KEYWORD_SEARCH",dtlocalsheet),1,"WebElement")
	Call Ambil_No_Akun_Dari_Table_With_Keyword(5,DataTable.Value("KEYWORD_SEARCH",dtlocalsheet),1,"WebElement")
	Call AC_GoTo_Menu()
...
ElseIf Iteration mod 3 = 0 Then
	Call Ambil_Nilai_Debit_With_Keyword(5,DataTable.Value("KEYWORD_SEARCH",dtlocalsheet),1,"WebElement",2,6)
	Call AC_GoTo_Menu()
