...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKAKT128-001 - Akuntansi - Transaksi - EJT - Cek Jurnal Settlement Transaksi Klaim P01.xlsx", "DPLKAKT128-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Lihat_Entry_Jurnal_Transaksi_All_Row_And_Compare()
Call DA_Logout("0")
Call spReportSave()
