...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM066-001 - Klaim Transaksi - Return to Reg - Klaim Pasca Kerja.xlsx", "DPLKKLM066-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Send_Back_To_Regristrasi_Klaim_Pasca_Kerja
Call AC_Logout()
