...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKLM055-001 - Klaim Transaksi - Calculate Klaim  - Send to Approval - Klaim Pasca Kerja.xlsx", "DPLKKLM055-001")
Call spGetDatatable()
...
Call DA_Login()
Call AC_GoTo_Menu()
Call Kirim_Ke_APR_Desk_Calculate_Klaim_Pasca_Kerja()
