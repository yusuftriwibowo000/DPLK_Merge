...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DPLKLib_Report.xlsx", "DPLKKPS148-001 - Kepesertaan - Inquiry - Inquiry Split Balance (Bulk).xlsx", "DPLKKPS148-001")
Call spGetDatatable()
...
Call ViewInquirySplitBalanceBulk()
